<article <?php hybrid_attr( 'post' ); ?>>
	...
	<?php if ( is_singular( get_post_type() ) ) : // If viewing a single post. ?>
		...
		<footer class="entry-footer">
			...
			<?php hybrid_post_terms( array( 'taxonomy' => 'post_tag', 'text' => esc_html__( 'Tagged %s', 'evoke' ), 'before' => '<br />' ) ); ?>
		</footer><!-- .entry-footer -->
	...
	<?php else : // If not viewing a single post. ?>
		...
		<div <?php hybrid_attr( 'entry-summary' ); ?>>
			...
			<p class="gallery-count"><?php printf( esc_html( _n( 'This gallery contains %s item.', 'This gallery contains %s items.', $count, 'evoke' ) ), $count ); ?></p>
		</div><!-- .entry-summary -->
